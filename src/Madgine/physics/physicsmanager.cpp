...
namespace Engine {
	namespace Physics {
		...
		Math::Vector3 ContactPoint::normal1() const
		{
		...
		void ContactPoint::setFriction(float motion, const Math::Vector3& dir, const Math::Vector3& dir2)
		{
